...
# 2. INTERACTIVE 3D NETWORK VISUALIZATION
...
# 3. CHORD DIAGRAM — INTER-REGIONAL LINE FLOWS
...
# 4. HEATMAP — REGION x REGION LINE DENSITY
...
# 7. ANIMATED MAP — GRID EXPANSION BY COMMISSIONING YEAR
...
# 8. VISUALIZATION SHOWCASE (gallery page)
